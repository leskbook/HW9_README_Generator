...
function generateREADME(answers) {
    ...
    //Set Screenshots template according to the user input
    let screenshots = '';
    if (answers.imageURL) {
...
//   * [ Project Links ](#Project-Links)
  ...
  * [ License ](#License)
  ...
  Email: ${answers.email}
  ## License
  This project license: [${answers.license.toUpperCase()}](https://choosealicense.com/licenses/${answers.license}/)<br />
  Copyright © ${year} [${answers.authorName.trim().toUpperCase()}](https://github.com/${answers.username.trim().toLowerCase()})
  
  <hr>
  <p align='center'><i>
  This README created by ${answers.authorName.trim().toUpperCase()}
  </i></p>
  `;
}
