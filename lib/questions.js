const questions = [{
    ...
    },
    {
        // Github REPO name
        type: 'input',
        message: 'Enter your Project Github Repo name (Response should = Repo name on Github):',
        name: 'repoName',
    ...
    },
    {
        ...
        validate: function(use) {
            ...
            return 'A professional README provides instructions on how to use the application.';
        },
    },
    {
        //Credits / Reference
        type: 'input',
        message: 'Enter contributors you wish to credit:',
        name: 'credits',
        validate: function(credits) {
            ...
            return 'Are you sure? Did you really do it alone?';
        },
    },
    {
        // Tests
